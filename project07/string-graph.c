 ...
 * Section: 0203
 *
 * Project 07 - A source file for project 07 containing the implementation
 * of required functions such as initializing a graph,
 * adding a node to a graph, and adding an edge to a graph
 *
...
void graph_init(String_graph *const graph)
{
    ...
    if (graph != NULL)
    {
        ...
        graph->vertex_list = malloc(sizeof(Vertex *));
